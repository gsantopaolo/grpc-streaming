...
namespace Server
{
    public class SensorHub : SensorService.SensorServiceBase
    {
        ...
        public override async Task SendTemperatureUpdates(TemperatureRequest request, IServerStreamWriter<TemperatureData> responseStream, ServerCallContext context)
        {
